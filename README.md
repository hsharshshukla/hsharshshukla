...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Focus-GenAI%20%2F%20RAG-orange?style=flat-square" alt="GenAI/RAG focus"/>
</p>

---

I have 13+ years of experience across enterprise applications, software development, systems integration, information platforms, and technical solution delivery — spanning business-critical enterprise systems, application integrations, information management, access control, and backend development.

My current focus combines that enterprise background with **backend and AI platform engineering** — particularly Python, APIs, Retrieval-Augmented Generation (RAG), vector databases, ML/NLP, and system design.
...
`FastAPI` `PostgreSQL` `Qdrant` `React` `RAG`
...
`Python` `OpenAI` `Hugging Face` `Pinecone` `ChromaDB`
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/ChromaDB-3B82F6?style=flat-square"/>
  <img src="https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white"/>
  <img src="https://img.shields.io/badge/Kubernetes-326CE5?style=flat-square&logo=kubernetes&logoColor=white"/>
  <img src="https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white"/>
  <img src="https://img.shields.io/badge/OpenTelemetry-425CC7?style=flat-square"/>
</p>
...
Before moving deeper into backend and AI platforms, I spent several years working with large enterprise environments involving SAP, enterprise content and information management platforms, application integrations, document lifecycle systems, and business-critical workflows.

That experience continues to shape how I approach software systems today — particularly around integration boundaries, security, maintainability, scalability, and solving problems in complex production environments.

---

<p align="center"><i>Focused on Backend Engineering, AI Platforms, System Design, and scalable enterprise applications.</i></p>
